...
export function AdminDashboard() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-10">
      ...
      <div className="mt-6 flex items-start gap-2 rounded-xl bg-[#e8e6dc]/60 p-4 text-sm text-muted-foreground">
        <ShieldCheck className="mt-0.5 h-4 w-4 shrink-0 text-[#788c5d]" />
        <p>
          Approving sets a therapist's <code className="font-heading">verification_status</code> to "approved" and
          makes them visible immediately on the public Browse page and Landing.
        </p>
      </div>
    </div>
  );
